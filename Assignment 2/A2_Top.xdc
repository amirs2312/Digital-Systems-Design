...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {sr[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[0]}]
set_property PACKAGE_PIN E19 [get_ports {sr[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[1]}]
set_property PACKAGE_PIN U19 [get_ports {sr[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[2]}]
set_property PACKAGE_PIN V19 [get_ports {sr[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[3]}]
set_property PACKAGE_PIN W18 [get_ports {sr[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[4]}]
set_property PACKAGE_PIN U15 [get_ports {sr[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[5]}]
set_property PACKAGE_PIN U14 [get_ports {sr[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[6]}]
set_property PACKAGE_PIN V14 [get_ports {sr[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[7]}]
set_property PACKAGE_PIN V13 [get_ports {sr[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[8]}]
set_property PACKAGE_PIN V3 [get_ports {sr[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[9]}]
set_property PACKAGE_PIN W3 [get_ports {sr[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[10]}]
set_property PACKAGE_PIN U3 [get_ports {sr[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {sr[11]}]
